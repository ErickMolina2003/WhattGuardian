...
export const FridgeIcon = (props) => (
  <MaterialCommunityIcons name="fridge-outline" size={24} {...props} />
);

export const WashingIcon = (props) => (
  <MaterialCommunityIcons name="washing-machine" size={24} {...props} />
);

export const TvIcon = (props) => (
  <FontAwesome name="television" size={24} {...props} />
);

export const AirIcon = (props) => (
  <MaterialCommunityIcons name="air-conditioner" size={24} {...props} />
);

export const MicrowaveIcon = (props) => (
  <MaterialCommunityIcons name="microwave" size={24} {...props} />
);

export const LaptopIcon = (props) => (
  <Entypo name="laptop" size={24} {...props} />
);

export const WaterHeaterIcon = (props) => (
  <FontAwesome name="thermometer" size={24} {...props} />
);

export const RemoveIcon = (props) => (
  <Ionicons name="remove-outline" size={24} {...props} />
);

export const AddIcon = (props) => (
  <Ionicons name="add-outline" size={24} {...props} />
);
